...
fn minimal_inputs() -> LearningInputs {
    LearningInputs {
        ...
        history_snapshots: vec!["## Goal\n- Initial goal\n".to_string()],
        inputs: vec!["First user instruction".to_string()],
        events_jsonl: r#"{"ts":"2026-05-23T10:00:00Z","source":"user","kind":"check","section":"Tasks & Progress","after":"Widget built"}"#.to_string(),
...
async fn produce_learning_llm_error_propagates() {
    ...
    impl Summarizer for FailingSummarizer {
        ...
        async fn regenerate_trajectory(&self, _: &str) -> Result<String> {
            anyhow::bail!("llm down")
        }
    }
